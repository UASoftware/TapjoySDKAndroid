 ...
 * 
 * For information about SDK integration, best practices and FAQs, please go to <a href="http://kc.tapjoy.com">http://kc.tapjoy.com </a>
 */
...
{ 
	...
	//================================================================================
	// RE-ENGAGEMENT AD Methods
	//================================================================================
	
	
	/**
	 * Retrieves the Re-engagement ad from the server.
	 * @param notifier				Class implementing TapjoyReEngagementAdNotifier for the Re-engagement ad callback.
	 */
	...
	/**
	 * Displays the Re-engagement fullscreen ad.
	...
	/**
	 * @deprecated This method now only sets the TapjoyVideoNotifier and starts caching (if allowed).  Videos are initialized automatically now.<br><br>
	...
	/**
	 * @deprecated This method is deprecated.  Use the Tapjoy dashboard to enable or disable caching.<br><br>
